      ...
      <div className="grid lg:grid-cols-2">
        ...
        <div className='px-10'>
            <div className="py-6 lg:py-8 flex flex-col ">
              ...
              <div className='text-right text-slate-500'>Already a member ? <Link className='text-blue-800' to='/login'>Log in</Link></div>
              <div className='px-16 py-5'>
                ...
                <button className='text-center text-white font-bold tracking-tight hover:bg-blue-600 w-full py-3 my-4 mt-14 rounded-md bg-[#4285f4]'>
                  <FontAwesomeIcon className='text-2xl align-text-bottom mx-2' icon={faGooglePlus} />
                  Signup with Google
                </button>
